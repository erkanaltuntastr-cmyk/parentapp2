export function Welcome(){
  ...
  container.innerHTML = `
    <h1 class="h1">A clear, structured view of a student's learning — aligned with the UK curriculum.</h1>
    <p class="sr-only" id="welcome-desc">Welcome to Oakwood easy parenting.</p>
    <div class="actions" aria-describedby="welcome-desc">
      <a class="button" href="#/add-child" data-role="primary-cta">Start with a student</a>
